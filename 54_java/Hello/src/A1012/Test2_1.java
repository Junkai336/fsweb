...
public class Test2_1 {
    public static void main(String[] args) {
        ...
        if (student2[0] > 3) {
            ...
            return;
        } else if (student2[1] > 20) {
            System.out.println("(반) 잘못된 정보입니다. (20이하로 입력)");
            return;
        } else if (student2[2] > 999) {
            System.out.println("(번호) 잘못된 정보입니다. (999이하로 입력)");
            return;
        }

        System.out.printf("학년:%01d, 반:%02d, 번호:%03d", student2[0], student2[1], student2[2]);
        System.out.printf("\n%01d%02d%03d", student2[0], student2[1], student2[2]);
