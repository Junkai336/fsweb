...
//    필드 주입 : 간단, 테스트 어려움, 결합도가 높아서 유지보수 어려움
...
//        System.out.println(saved.toString());
    ...
    public String index(Model model) {
        ...
        log.info("리스트의 총갯수는?. Article {}", articleEntityList.size());
        // 3. 뷰 페이지를 설정
...
//        return "";
    ...
    public String update(ArticleForm form) {
        ...
        // 2. 엔티티를 DB로 저장
            // 2-1. DB에서 기존 데이터를 가져옴 optional에서는 .orelse같은거 써줘야한다.
    ...
    public String delete(@PathVariable Long id, RedirectAttributes rttr) {
        ...
        // 1. 삭제 대상을 가져옴  <optional이라서 orelse써야함>
        ...
        if(target != null) {
            ...
            rttr.addFlashAttribute("msg", "삭제가 완료되었습니다.");
                    // Flash : 한번만. 이라는 뜻이 있다. 한번만 전달해 주고 삭제되는 역할?
        }
